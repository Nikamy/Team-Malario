    ...
    public partial class Main_Form : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            do
            {
                ...
                c_Left(x_Pos_Malario, y_Pos_Malario, 30, 30, gemalteslist_x_Pos[i], gemalteslist_y_Pos[i]);
                c_Above(x_Pos_Malario, y_Pos_Malario, 30, 30, gemalteslist_x_Pos[i], gemalteslist_y_Pos[i]);
                c_Underneath(x_Pos_Malario, y_Pos_Malario, 30, 30, gemalteslist_x_Pos[i], gemalteslist_y_Pos[i]);
                i++;
