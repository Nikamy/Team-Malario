...
namespace GDI_Malario
{
    class Level_Blöcke : Grundmethoden
    {
        ...
        {
            int y_Coordinate_PanelG = 537 - (24 * 2), x_Panel_Size = 0, y_Panel_Size = 0;
        ...
        public static void malen_MauerBlock(ref Graphics graphics, ref int zähler_Blöcke, ref int zähler_Block)
        {
